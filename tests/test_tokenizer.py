...
# Sowie das zauberische Fuhrwerk im dichten Gebüsch verschwand, noch im sanften Nachhallen der Harmonikatöne, fiel Balthasar, ganz außer sich vor Wonne und Entzücken, dem Freunde um den Hals und rief: Referendarius, wir sind gerettet!
    ...
    def test_tokenize_numbers_french(self):
        ...
        self.assertEqual (tokenize(u'-1 -2 3 -42', lang='fr'), [u'moins', u'un', u'moins', u'deux', u'trois', u'moins', u'quarante', u'deux'])
        self.assertEqual (tokenize(u'1,2 3.456', lang='fr'), [u'un', u'virgule', u'deux', u'trois', u'virgule', u'quatre', u'cent', u'cinquante', u'six'])
        self.assertEqual (tokenize(u'-42.23', lang='fr'), [u'moins', u'quarante', u'deux', u'virgule', u'vingt', u'trois'])
        self.assertEqual (tokenize(u'71', lang='fr'), [u'soixante', u'et', u'onze'])
        self.assertEqual (tokenize(u'72', lang='fr'), [u'soixante', u'douze'])
        self.assertEqual (tokenize(u'80', lang='fr'), [u'quatre', u'vingts'])
        self.assertEqual (tokenize(u'81', lang='fr'), [u'quatre', u'vingt', u'un'])
        self.assertEqual (tokenize(u'91', lang='fr'), [u'quatre', u'vingt', u'onze'])
        self.assertEqual (tokenize(u'92', lang='fr'), [u'quatre', u'vingt', u'douze'])
        ...
        self.assertEqual (tokenize(u'1000000 2234567', lang='fr'), [u'un', u'million', u'deux', u'millions', u'deux', u'cent', u'trente', u'quatre', u'mille', u'cinq', u'cent', u'soixante', u'sept'])
        self.assertEqual (tokenize(u'42,00,', lang='fr'), [u'quarante', u'deux', u'virgule', u'zéro', u'zéro'])
